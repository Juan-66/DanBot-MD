...
mobile: MethodMobile, 
browser: opcion == '1' ? ['DanBot-MD', 'Edge', '2.0.0'] : methodCodeQR ? ['DanBot-MD', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
...
(async () => {
global.conns = [];
const mainBotAuthFile = 'DanBotSession';
try {
